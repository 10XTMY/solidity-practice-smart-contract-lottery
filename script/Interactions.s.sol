...
contract FundSubscription is Script {
    ...
    function fundSubscription(
        ...
        console.log("Funding subscription with id: %s", subId);
        console.log("Using vrgCoordinator: %s", vrfcoordinator);
        if (block.chainid == 31337) {
            ...
            console.log(
                ...
                LinkToken(link).balanceOf(address(this))
            );
...
contract AddConsumer is Script {
    function addConsumer(
        ...
        console.log("Adding consumer to raffle: %s", raffle);
        console.log("Using vrgCoordinator: %s", vrfCoordinator);
        vm.startBroadcast(deployerKey);
